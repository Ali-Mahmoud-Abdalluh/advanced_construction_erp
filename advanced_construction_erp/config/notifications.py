...
def get_notifications():
    Notification = frappe.qb.DocType("Advanced Construction ERP Notification")
    query = (
        ...
        _notifications.append(
            {
                ...
                "reference_doctype": (
                    "deal" if notification.reference_doctype == "Advanced Construction ERP Deal" else "lead"
                ),
...
def mark_as_read(user=None, doc=None):
    ...
    for n in frappe.get_all("Advanced Construction ERP Notification", filters=filters, or_filters=or_filters):
        d = frappe.get_doc("Advanced Construction ERP Notification", n.name)
        d.read = True
        d.save()
...
def get_hash(notification):
    ...
    if notification.type == "Assignment" and notification.notification_type_doctype == "Advanced Construction ERP Task":
        _hash = "#tasks"
